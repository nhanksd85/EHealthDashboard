...
public class NPNConstants {
    ...
    public static List<NPNChannelModel> getOfflineChannelModels() {
        ...
        list.add(new NPNChannelModel("ZING MP3", R.drawable.open10d, R.drawable.open10d, "com.zing.mp3", R.drawable.zing_mp3, "#740ae5"));

        list.add(new NPNChannelModel("VTV GO", R.drawable.open10d, R.drawable.open10d, "vn.vtv.vtvgo", R.drawable.mega_vtvgo, "#ce1100"));
        ...
        list.add(new NPNChannelModel("iMEDIA TIVI", R.drawable.open10d, R.drawable.open10d, "com.kt.apps.media.xemtv", R.drawable.fpt3_small, "#ff6400"));
