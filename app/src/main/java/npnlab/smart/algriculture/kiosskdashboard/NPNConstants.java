...
public class NPNConstants {
    ...
    public static List<NPNChannelModel> getOfflineChannelModels() {
        ...
        list.add(new NPNChannelModel("NES GAME", R.drawable.open10d, R.drawable.open10d, "com.androidemu.nes", R.drawable.nesgame, "#000000"));
        list.add(new NPNChannelModel("CỜ TƯỚNG", R.drawable.open10d, R.drawable.open10d, "co.tuong", R.drawable.cotuong,"#063970"));
